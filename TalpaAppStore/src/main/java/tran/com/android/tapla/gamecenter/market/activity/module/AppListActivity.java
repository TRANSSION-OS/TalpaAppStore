...
//	private int specialId;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentViewBg(R.drawable.talpa_actionbar_background);
	}
...
//			specialName = getIntent().getStringExtra(SPECIAL_NAME);
	...
	private void initActionBar() {
		...
		if (openType == TYPE_NEW) {
			mActionBar.setTitle(R.string.tab_new, Color.BLACK);
		} 
		else if (openType == TYPE_STARTER) {
			mActionBar.setTitle(R.string.tab_starter, Color.BLACK);
		}
			...
			mActionBar.setTitle(R.string.tab_ranking, Color.BLACK);
