...
public class SearchUtils {
	...
	private RelativeLayout clear_history_btn_layout;
...
//	private SimpleAdapter mHistoryAdapter;
	...
	private RelativeLayout mRrecommendBtnLayout;
	...
	private void updateHistory() {
		...
		if (mHistoryRecords.size() == 0) {
			clear_history_btn_layout.setEnabled(false);
			clear_history_btn_layout.setVisibility(View.GONE);
		} else {
			clear_history_btn_layout.setEnabled(true);
			clear_history_btn_layout.setVisibility(View.VISIBLE);
		}
	}
...
//					.findViewById(R.id.search_history_list);
			...
			mRrecommendBtnLayout = (RelativeLayout) mBackgroundSearchLayout
...
//			mHistoryListView.setSelector(R.drawable.list_item_selector);
			...
			clear_history_btn_layout = (RelativeLayout) mBackgroundSearchLayout
					.findViewById(R.id.clear_history_btn_layout);
...
//		mHistoryListView.setAdapter(mHistoryAdapter);
	...
	public void updateHistoryLayout(List<Map<String, Object>> record) {
		if (record.size() > 0) {
			...
			mHistoryTextView1.setVisibility(View.GONE);
			mHistoryTextView2.setVisibility(View.GONE);
			mHistoryTextView3.setVisibility(View.GONE);
	...
	public void updateRecommendLayout(List<RecommendationItem> record) {
		if (record == null || record.size() == 0) {
			...
			mrecommendTextView1.setVisibility(View.GONE);
			mrecommendTextView2.setVisibility(View.GONE);
			mrecommendTextView3.setVisibility(View.GONE);
			mrecommendTextView4.setVisibility(View.GONE);
			mrecommendTextView5.setVisibility(View.GONE);
			mrecommendTextView6.setVisibility(View.GONE);
		}
		...
		if (record.size() > 0) {
			for (int i = 0; i < record.size(); i++) {
				if (i == 0) {
					...
					mrecommendTextView1.setVisibility(View.VISIBLE);
				} else if (i == 1) {
					mrecommendTextView2.setText(record.get(i).getName());
					mrecommendTextView2.setVisibility(View.VISIBLE);
				} else if (i == 2) {
					mrecommendTextView3.setText(record.get(i).getName());
					mrecommendTextView3.setVisibility(View.VISIBLE);
				} else if (i == 3) {
					mrecommendTextView4.setText(record.get(i).getName());
					mrecommendTextView4.setVisibility(View.VISIBLE);
				} else if (i == 4) {
					mrecommendTextView5.setText(record.get(i).getName());
					mrecommendTextView5.setVisibility(View.VISIBLE);
				} else if (i == 5) {
					mrecommendTextView6.setText(record.get(i).getName());
					mrecommendTextView6.setVisibility(View.VISIBLE);
				}
			}
