...
//		tv_text_horizontal.setAlpha(horProgress);
	...
	public void viewBackGroundAnimation(){
		...
		ObjectAnimator iconScaleX1 = ObjectAnimator.ofFloat(iv_icon, "scaleX", 1f, 0.85f);
		iconScaleX1.setDuration(200);
		iconScaleX1.setInterpolator(new AccelerateInterpolator());

		ObjectAnimator iconScaleY1 = ObjectAnimator.ofFloat(iv_icon, "scaleY", 1f, 0.85f);
		iconScaleY1.setDuration(200);
		iconScaleY1.setInterpolator(new AccelerateInterpolator());
		//延时100ms
...
//		textColor.setStartDelay(200);
		...
		topImgScaleY1.setDuration(200);
		//延时100ms
		ObjectAnimator topAlphaIn = ObjectAnimator.ofFloat(iv_icon, "Alpha", 0.0f, 1.0f);
	...
	public void viewBackGroundAnimation2(){
		AnimatorSet animatorSet = new AnimatorSet();//组合动画
		//背景
		background.setPivotY(background.getHeight()/2);
		background.setPivotX(background.getWidth()/2);
		...
		iconAlphaIn.setDuration(100);
		iconAlphaIn.setStartDelay(100);
		iconAlphaIn.addListener(iconListener2);
